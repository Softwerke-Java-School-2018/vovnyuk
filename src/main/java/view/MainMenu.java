...
import main.java.view.user.UserView;
import main.java.view.device.DeviceView;
import main.java.view.purchase.PurchaseView;

/**
 * A hub for the elements of main.java.view part.
 */
