...
public class DeviceSearchController {
    ...
    public void findDeviceByModel(String checkingModel) {
        ...
        if (entity.size() == 0) {
            ...
            if (i == entity.size()) {
                System.out.println("There is no device of such main.java.model (" + checkingModel + ")");
            }
        }
    }
